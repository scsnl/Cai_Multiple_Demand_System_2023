...
close_mtx = data['matched_state_closeness_mtx']
...
sns.heatmap(close_mtx, annot=True, yticklabels='', xticklabels='', cmap=cmap, center=0, square=True, linewidths=.5, vmax=1, vmin=-0)
